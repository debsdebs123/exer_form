...
<nav class="navbar navbar-expand-lg bg-body-tertiary">
  ...
  <input type="cadnome" class="form-control" id="nomecad" >

  <label for="cadtel"  class="form-label">Telefone: </label>
  <input type="cadtel" class="form-control" placeholder= "(xx) xxxxx-xxxx" id="telcad" >

  <label for="origem"  class="form-label" >Origem: </label>
  <br>
  <select class="form-control" class="form-select form-select-lg mb-3" aria-label=".form-select-lg example">
...
<br>
  ...
  <input type="date" class="form-control" id="datacont" >
